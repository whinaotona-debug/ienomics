...
import { esc } from './utils.js?v=163';
...
const PARENT_STEPS = [
  {
    target: null,
    title: 'イエノミクスへようこそ',
    body: '家庭の中でお金の動きを体験する、経済教育のアプリです。お手伝いを「お仕事」として発注し、ポイントで報酬を払います。まずは親の画面を一通り案内します。'
  },
  {
    target: 'synccode',
    title: '同期ID',
  ...
  },
  {
    target: 'job',
    title: 'お仕事を発注する',
    body: 'ここから仕事の内容・報酬・仕事の時間を決めて発注します。「定期的に繰り返す」をオンにすると、毎週や毎月、決めた時間に合わせて仕事が追加されます。定期は受注不要で、子供はすぐ完了報告できます。'
  },
  {
    target: 'templates',
    title: '定期一覧',
  ...
  },
  {
    target: 'invest',
    title: '資産運用',
    body: '日経平均やS&P500など、市場の値動きに合わせてポイントを運用できます。値上がりも値下がりもあります。'
  },
  {
    target: 'payments',
    title: '支払いの設定',
  ...
  },
  {
    target: 'tasklist',
    title: 'お仕事リスト',
    body: '進行中の仕事が、仕事の時間が近い順に並びます。完了報告が届いたら「付与」でポイントを渡し、直してほしいときは「やり直し」を押します。期限が近い仕事は色で知らせます。'
  },
  {
    target: 'inbox',
    title: 'お知らせ',
...
const CHILD_STEPS = [
  {
    target: null,
    title: 'イエノミクスへようこそ',
    body: 'おうちの なかで おかねの うごきを たいけんする、けいざい教育のアプリです。おしごとを して ポイントを もらいます。つかいかたを じゅんばんに せつめいします。'
  },
  {
    target: 'job',
    title: 'みつもりを おくる',
