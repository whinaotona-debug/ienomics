...
import { render } from './ui.js?v=222';
...
import { showAlert, showConfirm, showPrompt, showToast, setBusy } from './dialog.js?v=222';
import { startTutorial, hasSeenTutorial } from './tutorial.js?v=222';
import { initPush, isPushActive, isPushSupported, requestPushPermission as askPushPermission, unregisterPush, getPushError } from './push.js?v=222';
import { db, auth } from './firebase.js?v=222';
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('sw.js?v=222').catch(err => console.warn('SW登録失敗:', err));
  });
}