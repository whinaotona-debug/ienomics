...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('sw.js?v=255').catch(err => console.warn('SW登録失敗:', err));
  });
}