...
import { render } from './ui.js?v=228';
...
import { showAlert, showConfirm, showPrompt, showToast, setBusy } from './dialog.js?v=228';
import { startTutorial, hasSeenTutorial } from './tutorial.js?v=228';
import { initPush, isPushActive, isPushSupported, requestPushPermission as askPushPermission, unregisterPush, getPushError } from './push.js?v=228';
import { db, auth } from './firebase.js?v=228';
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('sw.js?v=228').catch(err => console.warn('SW登録失敗:', err));
  });
}