...
import { render } from './ui.js?v=183';
import { applyFuriganaState, requestPushPermission, sendPushNotification, getTemplateIdFromTask, dateKeyToValue, getCurrentMarketRates, japanTodayKey, japanParts, japanDeadlineMs, msUntilJapanMidnight, marketNameFromId, MARKET_META, getInvestmentPortfolioValue, getHoldingValue, getHoldingShares, getInvestmentValues, getActiveInvestments, normalizeSheetUrl, parseMarketSheetCsv, setMarketSheetSeries, scheduledPaymentAmount } from './utils.js?v=183';
import { showAlert, showConfirm, showPrompt, showToast, setBusy } from './dialog.js?v=183';
import { startTutorial, hasSeenTutorial } from './tutorial.js?v=183';
import { initPush, isPushActive, isPushSupported, requestPushPermission as askPushPermission, unregisterPush, getPushError } from './push.js?v=183';
import { db, auth } from './firebase.js?v=183';
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('sw.js?v=183').catch(err => console.warn('SW登録失敗:', err));
  });
}